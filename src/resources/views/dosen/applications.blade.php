...
@section('title', 'Applications Submission')
@section('page-title', 'Applications Submission')
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 mb-3 mb-md-0">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Search applications..." class="form-control-modern w-100">
                    </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-avatar me-3">
                                                @if ($application->submittedBy->identity && $application->submittedBy->identity->image)
                                                    <img src="{{ $application->submittedBy->identity->image_url }}"
                                                        alt="Profile">
                                                @else
            ...
            document.getElementById('assignReviewerBtn').addEventListener('click', function() {
                ...
                fetch(`/dosen/applications/${selectedApplicationId}/choose-reviewer`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            // Close modal
                            bootstrap.Modal.getInstance(document.getElementById('chooseReviewerModal'))
                                .hide();
